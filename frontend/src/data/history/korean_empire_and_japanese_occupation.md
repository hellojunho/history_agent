...
**시대적 특징**- 개항(1876) → 갑오개혁(1894) → 대한제국(1897) → 국권 피탈(1910)
...
|**관민공동회·헌의6조 **| 1898 | 정부 관료+독립협회, 의회 설립 요구           |** 헌의6조**(관민공동회 결의)
...
> [!IMPORTANT]
>**을사늑약(1905)**: 고종의 서명 없이 강제 체결 → 무효 주장. 황성신문 '시일야방성대곡(장지연)', 매국 을사오적(이완용·박제순·이지용·이근택·권중현) 규탄** 항일 의거**- 최익현: 태인 의병(1906)
- 민영환·조병세: 자결 순국
- 나철: 단군교(대종교) 창시(1909)
...
|**자유시 참변 **| 1921    | 러시아 적군                      | 자유시(러시아)의 독립군 강제 무장해제                    |** 독립군 재편 과정**```mermaid
flowchart LR
    A["참의부·정의부·신민부\n(1920년대)"] --> B["국민부(남만주)\n혁신의회(북만주)\n(1929)"]
    B --> C["조선혁명군(남만주)\n한국독립군(북만주)\n(1930년대)"]
    C --> D["한국광복군(충칭)\n(1940)"]
...
> [!TIP]
>**자주 출제되는 비교 포인트 **- ⭐** 강화도 조약(1876)**: 최초 근대 조약, 불평등 조약, 치외법권·해안 측량권
